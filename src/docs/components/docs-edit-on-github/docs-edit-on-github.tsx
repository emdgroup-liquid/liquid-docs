...
/** @internal **/
@Component({
  tag: 'docs-edit-on-github',
  styleUrl: 'docs-edit-on-github.css',
  shadow: false,
})
export class DocsEditOnGithub {
  ...
  /** Repository path to be passed from eleventy. */
  @Prop() repoPath!: string
    ...
    return (
      <Host class="docs-edit-on-github">
        <a
          ...
          href={`https://github.com/${this.repoPath}/blob/develop/${this.path}`}
          target="_blank"
